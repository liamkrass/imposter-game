...
function Landing({ setRoom, setPlayerName, setError }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] w-full max-w-md mx-auto p-6 animate-fade-in relative z-10">
            {/* Logo / Header */}
            <div className="mb-10 text-center">
                <h1 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500 drop-shadow-[0_0_15px_rgba(139,92,246,0.5)] mb-2">
                    Imposter
                </h1>
